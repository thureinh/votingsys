...
<ul class="nav nav-tabs" id="myTab" role="tablist">
  <li class="nav-item">
    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">‌ရွေးကောက်ပွဲဖန်တီးရန်</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">ထည့်သွင်းပြီး‌ရွေးကောက်ပွဲများကိုကြည့်ရန်</a>
  </li>
</ul>
<div class="tab-content" id="myTabContent">
  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">

<h2 class="mt-2">ရွေးကောက်ပွဲဖန်တီးရန်</h2>

<form id='form1' class="mt-4">
    <div class="form-group row my-4">
    <div class="col-2">
      <label for="electionSelect" class="font-weight-bolder" style="margin-top: 11px;">‌ရွေးကောက်ပွဲ‌ရွေးချယ်ရန်  : </label>
    </div>
      <div class="col-10">
        <select class="form-control form-control-lg" name='election' id='electionSelect' required >
        <option value="" selected>အောက်ပါ‌ရွေးကောက်ပွဲများမှတစ်ခုကိုရွေးပါ</option>
  <?php
  foreach ($elections as $value) {
    $date=DateTime::createFromFormat('Y-m-d',$value['edate']);
    $eday=$date->format('jS M Y');
  ?>
<option value="<?php echo $value['eid']; ?>">&nbsp;အမည် : <?php echo $value['ename']; ?> , <?php if(!empty($value['eyear_end'])) { ?>[  <?php echo $value['eyear_begin']; ?> မှ ~  <?php echo  $value['eyear_end']; ?> ထိ ]<?php }else { ?>[ <?php echo $value['eyear_begin']; ?> ]<?php } ?> , ‌ကျင်းပမည့်နေ့ : <?php echo $eday ?>
</option>
  <?php  
    }
  ?>
  ...
  <div class="form-group row my-4">
    <div class="col">
    <label class="font-weight-bolder">မဲဆန္ဒနယ်‌ရွေးရန် : </label>
...
<div class="form-check">
  ...
  ?>
    ...
    <label class="custom-control-label" for="customControlValidation<?php echo $count; ?>">
       <b>အမည်</b> : <?php echo $value['con_name']; ?> , <b>မြို့နယ်</b> : <?php echo $value['township']; ?>
    </label>
  </div>
  <?php
  }
  ...
  <div class="form-group row mt-0 mb-4">
        <div class="col-6">
    <label for="dpd-priBtn1" style="text-align: center;" class="col-form-label"><b>ပါတီ‌ရွေးရန် : </b></label>
<div class="btn-group dropup" id="btn-group1">
  <button type="button" style="width: 400px;height: 60px" class="btn btn-primary border dropdown-toggle" id="dpd-priBtn1" data-toggle="dropdown" value="" data-display="static" aria-haspopup="true" aria-expanded="false" disabled >
    ပါတီများကြည့်ရန်ဤနေရာကိုနှိပ်ပါ
  </button>
...
<img src="../uploads/cross-restricted.png" id='hidden-cross1' style="width: 25px;height: 25px;display: none;" class="rounded ml-2" data-toggle="tooltip" data-placement="bottom" title="Clear Selection" alt="wait">
  ...
  <div class="col-6">
    <label for="select-Candidate" class="col-form-label"><b>ကိုယ်စားလှယ်ရွေးရန် : </b></label>
<div class="btn-group dropup" id="btn-group2">
  <button type="button" style="width: 400px;height: 60px" class="btn btn-primary border dropdown-toggle" id='dpd-priBtn2' value="" data-toggle="dropdown" data-display="static" aria-haspopup="true" aria-expanded="false" disabled >
    ကိုယ်စားလှယ်ကြည့်ရန်ဤနေရာကိုနှိပ်ပါ
  </button>
  <div class="dropdown-menu dropdown-menu-lg-right" style="max-height: 300px;overflow-y: auto">
    <?php 
    if(empty($candidates)){
...
<img src="../uploads/cross-restricted.png" id='hidden-cross2' style="width: 25px;height: 25px;display: none;" class="rounded ml-2" data-toggle="tooltip" data-placement="bottom" title="Clear Selection" alt="wait">
  ...
  <div class="form-group row my-4">
    ...
    <button type="button" id='createBtn' class="btn btn-primary btn-lg">ထည့်သွင်းမည်</button>
  </div>
  </div>
  </div>
</form>
  ...
  <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">‌ထည့်သွင်းပြီးရွေးကောက်ပွဲပြဇယား</h6>
            </div>
            <div class="card-body">
               ...
               <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th></th>
                      <th></th>
                      <th>ရွေးကောက်ပွဲအမည်</th>
                      <th>မဲဆန္ဒနယ်</th>
                      <th style="text-align: center;vertical-align: middle;">ဓာတ်ပုံ</th>
                      <th>ကိုယ်စားလှယ်လောင်းအမည်</th>
                      <th>ကိုယ်စားလှယ်လောင်း၏ပါတီ</th>
                      <th>Actions</th>
                    </tr>
                  </thead>
                  <tfoot>
