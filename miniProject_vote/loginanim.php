...
<?php require 'include/navbar.php'; ?>
  <form action="dbprocessor.php" class="mt-5" method="POST">
  	<input type="hidden" name="postp" value="login">
	...
	<input type="email" id="loginEmail" name="admname" maxlength="254" />
		<p class="helper helper1">email@domain.com</p>
	</div>
	<div class="inputGroup inputGroup2">
	<label for="loginPassword" id="loginPasswordLabel">Password</label>
		<input type="password" id="loginPassword" name="admpass" />
	...
	<div class="inputGroup inputGroup3">
		<button style="height: 53px">Log in</button>
		<button style="margin-top: 5px;height: 53px" type="button" onclick="location.replace('../')">Go To Main Login Page</button>
	</div>	
</form>
